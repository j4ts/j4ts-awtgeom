declare namespace java.awt.geom {
    ...
    class AffineTransform {
         ...
         * @return {java.awt.geom.AffineTransform} an <code>AffineTransform</code> object that is a rotation
         ...
         * @param {java.awt.geom.AffineTransform} Tx the <code>AffineTransform</code> object from which to
         * copy the transform
         * @since 1.2
         */
         ...
         * @param {java.awt.geom.Point2D} ptSrc the specified <code>Point2D</code> to be transformed
         * @param {java.awt.geom.Point2D} ptDst the specified <code>Point2D</code> that stores the
         * result of transforming <code>ptSrc</code>
         * @return {java.awt.geom.Point2D} the <code>ptDst</code> after transforming
         ...
         * transformed point.
         * @param {java.awt.geom.Point2D} ptSrc the point to be inverse transformed
         * @param {java.awt.geom.Point2D} ptDst the resulting transformed point
         * @return {java.awt.geom.Point2D} <code>ptDst</code>, which contains the result of the
         * inverse transform.
         ...
         * point.
         * @param {java.awt.geom.Point2D} ptSrc the distance vector to be delta transformed
         * @param {java.awt.geom.Point2D} ptDst the resulting transformed distance vector
         * @return {java.awt.geom.Point2D} <code>ptDst</code>, which contains the result of the
         * transformation.
         * @since 1.2
         */
...
declare namespace java.awt.geom {
     ...
     * @class
     */
    class Area implements java.awt.Shape {
         ...
         * @return {java.awt.geom.PathIterator} the <code>PathIterator</code> object that returns the geometry of
    ...
    class AreaIterator implements java.awt.geom.PathIterator {
        ...
        constructor(curves: Array<any>, at: java.awt.geom.AffineTransform);
        getWindingRule(): number;
        isDone(): boolean;
        next(): void;
        currentSegment$float_A(coords: number[]): number;
...
declare namespace java.awt.geom {
     ...
     * @class
     */
    abstract class CubicCurve2D implements java.awt.Shape {
         ...
         *
         * @param {java.awt.geom.CubicCurve2D} c
         ...
         *
         * @param {java.awt.geom.CubicCurve2D} src
...
declare namespace java.awt.geom {
    ...
    abstract class Dimension2D {
         ...
         *
         * @param {java.awt.geom.Dimension2D} d
...
declare namespace java.awt.geom {
     ...
     *
     * @param {java.awt.geom.PathIterator} src
...
declare namespace java.awt.geom {
     ...
     * @class
     */
    abstract class Line2D implements java.awt.Shape {
        abstract getBounds2D(): any;
        constructor();
        /**
         * Returns the X coordinate of the start point in double precision.
         ...
         *
         * @param {java.awt.geom.Point2D} pt
         ...
         * @return {java.awt.geom.PathIterator} a {@link PathIterator} that defines the boundary of this
         * <code>Line2D</code>.
         * @since 1.2
         */
        getPathIterator$java_awt_geom_AffineTransform(at: java.awt.geom.AffineTransform): java.awt.geom.PathIterator;
         ...
         * ignored.
         * @return {java.awt.geom.PathIterator} a <code>PathIterator</code> that defines the boundary of the
...
declare namespace java.awt.geom {
     ...
     * @class
     */
    class NoninvertibleTransformException extends Error {
...
declare namespace java.awt.geom {
     ...
     * @class
     */
    abstract class QuadCurve2D implements java.awt.Shape {
        abstract getBounds2D(): any;
        constructor();
        /**
         ...
         * @param {java.awt.geom.Point2D} p1
         * the start point
         * @param {java.awt.geom.Point2D} cp
         * the control point
         * @param {java.awt.geom.Point2D} p2
         * the end point
         * @since 1.2
         ...
         * <code>QuadCurve2D</code>.
         *
         * @param {java.awt.geom.QuadCurve2D} c
         ...
         *
         * @param {java.awt.geom.QuadCurve2D} src
         ...
         * boundary
         * @return {java.awt.geom.PathIterator} a {@link PathIterator} object that defines the boundary of the
         * shape.
         * @since 1.2
         */
        getPathIterator$java_awt_geom_AffineTransform(at: java.awt.geom.AffineTransform): java.awt.geom.PathIterator;
         ...
         * connecting the end points.
         * @return {java.awt.geom.PathIterator} a <code>PathIterator</code> object that defines the flattened
         * boundary of the shape.
         * @since 1.2
         */
        getPathIterator$java_awt_geom_AffineTransform$double(at: java.awt.geom.AffineTransform, flatness: number): java.awt.geom.PathIterator;
...
declare namespace java.awt.geom {
     ...
     * @class
     */
    abstract class RectangularShape implements java.awt.Shape {
        abstract getBounds2D(): any;
         ...
         *
         * @param {java.awt.geom.Point2D} loc
         * the specified <code>Point2D</code>
         * @param {java.awt.geom.Dimension2D} size
         ...
         * @param {java.awt.geom.Point2D} corner
         ...
         * @return {java.awt.geom.PathIterator} a <code>PathIterator</code> object that provides access to the
...
declare namespace java.awt {
    ...
    interface Shape {
         ...
         * @return {java.awt.geom.PathIterator} a new <code>PathIterator</code> that independently traverses
...
declare namespace sun.awt.geom {
    interface PathConsumer2D {
         ...
         * when a {@link java.awt.geom.PathIterator} returns
...
declare namespace java.awt.geom {
     ...
     * @class
     */
    abstract class Path2D implements java.awt.Shape {
        abstract getBounds2D(): any;
        /**
    ...
    namespace Path2D {
        ...
        class Double extends java.awt.geom.Path2D {
             ...
             * @return {java.awt.geom.PathIterator} a new {@code PathIterator} that iterates along the boundary
...
declare namespace java.awt.geom {
    ...
    abstract class Arc2D extends java.awt.geom.RectangularShape {
         ...
         *
         * @param {java.awt.geom.Point2D} loc The <CODE>Point2D</CODE> representing the coordinates of
         * the upper-left corner of the arc.
         * @param {java.awt.geom.Dimension2D} size The <CODE>Dimension2D</CODE> representing the width
         ...
         * this arc to the specified values.
         *
         * @param {java.awt.geom.Rectangle2D} rect The framing rectangle that defines the
         ...
         *
         * @param {java.awt.geom.Arc2D} a The <CODE>Arc2D</CODE> to use to set the arc's values.
         * @since 1.2
         */
         ...
         * from the first point around to the second point.
         *
         * @param {java.awt.geom.Point2D} p1 The <CODE>Point2D</CODE> that defines the arc's
         * starting point.
         * @param {java.awt.geom.Point2D} p2 The <CODE>Point2D</CODE> that defines the arc's
         * ending point.
         * @since 1.2
         */
         ...
         * the specified rectangle.
         *
         * @param {java.awt.geom.Rectangle2D} r The <CODE>Rectangle2D</CODE> to test.
         *
         * @return {boolean} <CODE>true</CODE> if the arc contains the rectangle,
         * <CODE>false</CODE> if the arc doesn't contain the rectangle.
         * @since 1.2
         ...
         *
         * @param {java.awt.geom.AffineTransform} at an optional <CODE>AffineTransform</CODE> to be applied
         * to the coordinates as they are returned in the iteration, or null
         * if the untransformed coordinates are desired.
         *
         * @return {java.awt.geom.PathIterator} A <CODE>PathIterator</CODE> that defines the arc's boundary.
         * @since 1.2
         */
        getPathIterator$java_awt_geom_AffineTransform(at: java.awt.geom.AffineTransform): java.awt.geom.PathIterator;
        /**
...
declare namespace java.awt.geom {
    ...
    abstract class RoundRectangle2D extends java.awt.geom.RectangularShape {
         ...
         * <code>RoundRectangle2D</code>.
         *
         * @param {java.awt.geom.RoundRectangle2D} rr
