...
public final class InternalPreconditions {
  private static final boolean CHECKED_MODE = false;
  private static final boolean TYPE_CHECK = false;
  private static final boolean API_CHECK = false;
  private static final boolean BOUND_CHECK = false;
  ...
  private static String format(String template, Object... args) {
    ...
    for (int i = 0; i < args.length; i++) {
      template = string(template).replace(template, (String) args[i]);
    }
